export function PageHero({ eyebrow, title, text, image }: { eyebrow: string; title: string; text: string; image: string }) {
  return (
    <section className="premium-section min-h-[50vh] flex items-center bg-[#07111f] text-white">
      <img src={image} className="absolute inset-0 h-full w-full object-cover opacity-45" />
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 py-24 sm:px-6 lg:px-8 lg:py-28">
        <div className="max-w-3xl fade-up">
          ...
          <h1 className="text-[36px] font-extrabold leading-[1] tracking-[-0.045em] text-white sm:text-[48px] lg:text-[60px]">{title}</h1>
